...
// Zobrazíme zprávu o načtení HALLA nástrojů po úplném startu QCADu.
// Použijeme časovač, abychom zajistili, že se zpráva zobrazí až po dokončení všech inicializačních procesů.
var hallaStartupTimer = new QTimer(qApp);
include("scripts/EAction.js"); // Přidáno pro zpřístupnění EAction
hallaStartupTimer.singleShot = true;
hallaStartupTimer.timeout.connect(function() {
    EAction.handleUserMessage("✅ Menu a nástroje HALLA načteny.");
});
hallaStartupTimer.start(500); // 0.5s zpoždění pro jistotu
